...
(Quick note: As a requirement of receiving my last paycheque, I did sign the gag letter Robert McQueen sent me. However, I retained the right to be critical of the Foundation's directors, past and present. If any of the strategy below reads critically, rest assured my only interest is in helping the Foundation continue to grow into its next 25 years.)

[Like Nick](https://www.youtube.com/watch?v=dR_Uzf2B-YA&t=106s), I had no idea what happened back in August. I worked almost exclusively with Allan Day throughout my 3.5 months at the Foundation. Immediately following GUADEC, Allan went on vacation for a couple weeks and during that time the board held a few meetings I wasn't invited to. On August 13th, I was told I "wasn't a good fit." I think (hope?) that Allan was as surprised as I was when he returned from vacation on August 18th. My agreement to step down was largely due to the total lack of communication from the board at that time. People joke about an Executive Director having "nine bosses", which is its own kind of challenge but that challenge deepens if your bosses don't speak to you. The board's half of the decision was never discussed with me and their decision was never explained.

I still have no idea what happened in August. I'm beginning to believe I never will. I'm still frustrated by this: Between the 6-month interview process, the 3 or 4 month stint, and the offboarding period, this consumed nearly a year of my life and career. That said, I'm finally getting my head above water, so I'm taking the time to publish the strategy I'd laid out while I was with the GNOME Foundation.
...
This strategy is broken down into two broad conceptual shifts in how the GNOME Foundation operates:

1. Focus On The Mission
2. Build An Institution

These each have quite a few items underneath them, but they provide useful questions for the community executive to ask themselves from time to time: "Are we focusing on the mission?" and "Are we building an institution?"
...
[As recently as the 2024 submission](https://projects.propublica.org/nonprofits/organizations/43572618), the mission statement was actually a bit clearer in its intent:
...
* fiscal policy
  ...
  * balance the budget, YoY
  * board reserve

* fundraising
  * slide deck (costs can be derived from 990s)
  * d.g.o
  * fund development
  * talk about gnome on podcasts, youtube
  * stop Canonical from patching out Donate notification in Ubuntu

---
title: "GNOME Foundation 2.0: Executive Strategy"
...
(Cooling off emotionally was important because August left me confused and, honestly, frightened. In my 30 years of employment, this is the first time I've ever felt _unsafe_ at a workplace. It's a real brainscrew to know somebody had a problem with me, that they were willing to escalate to the board without bringing it to me first, and that the problem, whatever it was, caused the board to ask me to leave --- without a clear indication _what that problem might be._ I was completely in the dark and there is nothing as scary as one's own imagination. When I re-read the announcement from September, I realized it reads "he did everything right...but we still had to part ways." It looked like I'd embezzled money or abused someone or something else equally insane. I needed some distance from that.)

* * *

Quick note: As a condition of receiving my last paycheque, I did sign [_One Of Those Things_](https://youtu.be/NUC2EQvdzmY). However, I retained the right to speak critically of the Foundation, its staff, and its directors --- past and present. If the comment above, or any of the strategy below, reads critically, rest assured my only interest is in helping the Foundation continue to grow into its next 25 years. I still really want the Foundation to succeed.

* * *

This strategy hinges on three broad conceptual shifts in how the GNOME Foundation operates:
...
* [Build An Institution](#build-an-institution)
  * [Succession Planning](#succession-planning)
  * [Nurture The Next Generation](#nurture-the-next-generation)
  * [Committee Rotation](#committee-rotation)
  * [Slow Board Rotation](#slow-board-rotation)
  * [Documentation](#documentation)
  * [Network Resilience](#network-resilience)
* [Grow The Community](#grow-the-community)
* [Events: Succession In Action](#events-succession-in-action)
* [Advisory Board: The Old-Timer Meeting Ground](#advisory-board-the-old-timer-meeting-ground)
* [Stop The Slow Bleed](#stop-the-slow-bleed)
* [Heavy Communication With Members](#heavy-communication-with-members)
* [Financial Policy](#financial-policy)
* [Fiscal Controls](#fiscal-controls)
...
As recently as [the 2024 (FY23) IRS  submission](https://projects.propublica.org/nonprofits/organizations/43572618/202412259349302181/full), the mission statement was actually a bit clearer in its intent:
...
...but I'm guessing most of us can agree that both mission statements are equally applicable and that the activity the GNOME Foundation was incorporated to engage in is "build a Free Software desktop", where "free" takes both meanings and "desktop" also applies to rectangle form-factor computers like laptops and phones.

In short, the GNOME Foundation exists to support the development of GNOME. Nothing else.
...
This applies even more acutely to nonprofits than it does to for-profit companies. There is no such thing as a 501(c)(3) nonprofit "family business." The institution is everything.
...
While I was in the ED role, I think people were surprised that I didn't shy away from the topic of death. Americans, in particular, seemed bothered by this. (One person even demanded that I not say "bus factor.") I did avoid the topic with the two Americans who requested it of me. I [provided content warnings](https://youtu.be/26ys1p6VVs0?si=eafOWsUprdsQhwY3&t=46) in group contexts. But the fact that more than one person raised the issue with me led me to reflect on the topic more deeply in the autumn.
...
Keeping one person in the same role without redundancy for years and years also has a tendency to cause gatekeeping. We all fall victim to the habit of gatekeeping, even unconsciously. And it has a tendency to perpetuate itself: if I'm the only person who's done a job for 5, 10, or 15 years, I'm bound to start believing I'm the _only_ person who can do that job. Of course this is never true, so it's always a good idea to make sure at least one other person understands how you do your job.
...
Paradoxically, I would love to see the board _slow_ its rotation. Prior to Holly Million's appointment as ED, the board would sometimes rotate in its entirety _every single year._ Holly, with her nonprofit experience, helped the board fix that bug. However, when I asked past directors if they would be willing to re-join the board, I would hear this, in an exhausted voice: "if I'm asked to serve, I can."

Serving on the board should be neither a luxury, nor a chore. It should strike a balance between the serious work of governance and avoiding burnout. Ideally, elections should decide when a board member is rotated out. At the moment, barely enough members run for elections to fill the available seats. I had to coax all four candidates in the 2025 elections to run.

A slower board rotation would indicate a few things: It would indicate that the work is no longer soul-crushing. It would indicate that the membership is actually happy with the work the Foundation does. It would indicate that the directors are getting comfortable with the few small operational tasks required of a working board in an organization of this scale.

Combining succession planning with slower board rotation, the outcome should be healthy evolution: the longest-serving board members are asked to step out of Officer roles and, eventually, bow out of the board.

### Documentation

When I joined the GNOME Foundation, there was no operational or executive documentation to speak of. This was, in part, a tooling problem: the Foundation had jumped between wikis and GitLab and Nextcloud and Google Docs on multiple occasions. Still, 25 years is a long time to go without even basic SOPs. While I was there, Bart and Andrea created a single, private, go-to Sphinx instance in the style of [https://handbook.gnome.org](https://handbook.gnome.org) --- I sincerely hope this is still going and that the board is incrementally fleshing it out.

Clear documentation, centralized at a single location, is how the Foundation will manage its people transitions. Hand-offs are great, but board members and staff alike should have a single README-style resource from which they can find everything else they need to keep the Foundation running smoothly. That's the Foundation Handbook.

I should clarify that non-operational processes were well documented: board policies, accounting practices (courtesy Rebecca the bookkeeper), and infrastructure blueprints (courtesy Bart and Andrea). But even these need to be discoverable, which is where the Foundation Handbook comes in. If someone has a question about infrastructure, their first port of call should be a document linked from the Handbook, not waking up Andrea in the middle of the night.
...
I'll pause here to explain part of why I think this is so important. It's not a beef with the current GNOME docs; they're quite lovely. The importance is capturing the moment. Desktop Linux is going gangbusters. Meanwhile, every senior dev and their cat is trying to think of an app to build on top of local-first tech like [p2panda](https://p2panda.org/) and [Automerge](https://automerge.org/). Most of the people switching to Linux are, themselves, developers who are fed up with MacOS. A lot of those developers will just [do what Linus does](https://youtu.be/mfv0V1SxbNA?si=yte6DTa9MMuOdHSj&t=2711) and install Fedora. They will probably run GNOME. If they want to spend a weekend tossing together a D&D campaign manager app, recipe app, or the perfect local-first todo list app, the Foundation should encourage that. Native app development on Linux is _fun_ and _addictive._ Good quickstart docs are the gateway drug, and they're cheap to make. (Cheaper than maintaining [Workbench](https://flathub.org/en/apps/re.sonny.Workbench), though the Quickstart itself should probably point Workbench out to the reader, who would have never heard of it.)
...
Paying platform developers means more than internships. While internships are a wonderful way to encourage inexperienced folks to build their skills and contribute to open source, they have a pretty low hit rate of keeping people in the f/oss ecosystem, historically. Why? Because everyone needs to eat. If there aren't jobs in GNOME tech after an internship finishes, a GNOME intern is just going to get gobbled up writing Yet Another React App or some cloud-native doodad in Go. It's not 1997. You can't assume these folks are going to sacrifice every evening and weekend for open source anymore.

Instead, it's preferable to find someone who would be a "lateral hire" in a regular company. The global income gap sucks in just about every way... except for this. If you have $1500/mo to spend on maintaining GLib, find a C hacker in a developing economy for whom that's a comfortable salary. Then give them a 12-month fellowship and see what happens.
...
The majority of directors on the board now see change --- healthy change --- as good for the Foundation. These changes, slow as they may have been to begin with, started long before I ever joined as ED. They continue today. Despite the strange lack of communication throughout and after August, I still firmly believe that the GNOME Foundation is the strongest it has ever been. If you have been wondering if you should stand for elections in 2026, do it. If you aren't sure if your vote matters in the elections, let me reassure you that it matters now more than ever.

If you feel, as many members do, that the Foundation and the Project have been at odds in recent years, there is a new opportunity to help the Foundation correct its course, stabilize, and grow GNOME.

Now. Just as it's the duty of the membership to improve the Foundation, it's the Foundation's responsibility to improve relationships on the project.

One of the Foundation's advisors recommended to me that the Foundation needs to learn to "release incompatible folks." I agree. The vast, _vast_ majority of GNOME contributors are lovely people doing incredible work. But sometimes problematic folks need to be asked to step away from the organization even if they aren't technically violating the Code of Conduct. Learning to have those difficult conversations is the job of Foundation management.

## Heavy Communication With Members

Because the executive is beholden to the board and the board is beholden to the membership, it is obvious (I would hope) that the executive and board should both communicate frequently and transparently with members.

I love reading [Allan's Foundation Updates](https://blogs.gnome.org/aday/), a continuation of a practice we started while I was ED. Just before I left, I'd started hosting office hours. I'd also hoped to have quarterly panels. It's not possible for the ED or the President to have one-on-ones with every single Foundation member, all the time. But there should be opportunities outside of Matrix to engage in open and honest conversation.

## Financial Policy

I was very happy to see that the board [continued with the financial policy I introduced](https://discourse.gnome.org/t/foundation-budget-report-2025-26/32629). Of which, the most important aspects are the following:
...
Run a nonprofit like any other business.

## Fiscal Controls

While I was at the Foundation, we [began the process of implementing and documenting internal controls](https://blogs.gnome.org/steven/2025/07/05/2025-07-05-foundation-update/). We had some fantastic advice from our bookkeeper and accounting advisor. I'm told these improvements are continuing and that the Foundation is incrementally tightening its financial policy.
...
Within my first few weeks at the Foundation, I "pitched" a new fundraising strategy with the twofold goal of:
...
The second step is to make the Foundation a grantmaker, one way or another. Either to use unrestricted funds to solve an acute problem over a narrow timeframe (say, 3 months) or to provide a fellowship, similar to what the Rust Foundation used to do with their Grants Program. Or something else entirely. As long as the GNOME Foundation starts paying hackers directly with unrestricted donations, it's a grantmaker. It doesn't really matter how.

Where does the money go, though? Are donors paying for GNOME Calendar, Flatpak 2.0, or bugfixes in GNOME Online Accounts? This is tricky. The Foundation can't dictate the technical direction of the project, and that includes technical priority. But it shouldn't completely ignore the desires of donors, either. Striking a balance between [the nascent steering group](https://www.youtube.com/live/18Ir6RXkIeA?si=uwOFJUYtRga7hYTZ&t=3381) and feedback from donors would be a process of experimentation and discovery. Luckily, most corporate donors are primarily interested in _infrastructure._ They'd rather fix libraries and services than apps or GNOME Shell. So perhaps it would be natural for the Foundation's grantmaking to focus on user-visible changes which, in turn, would lead to more donations, since donors could see the positive change their donations make. A virtuous circle.
...
Raising a complaint _about_ someone without first speaking to that person directly is a bizarre and unhealthy pattern of behaviour. It's not feedback, it's whining. Try not to do that. Before escalating to the ED, the board, or the CoCC, talk to the person you're having difficulty with. They may be receptive. They may not. But it's worth your effort, every time.
...
Historically, the Foundation struggled to hold its staff, directors, and officers accountable for patterns of broken behaviour. I am not referring to one-off mistakes: a forgotten task, a momentary lack of judgment, or a dropped ball. _Patterns of behaviour_ are marked by repeatedly failing to deliver: repeatedly failing to own a task, project, or strategy from start to finish.

This situation is improving now, bit by bit.

Just as there are two scales to the Foundation (the board and the staff), there are two scales to accountability. Staff need to be held accountable for work at the task or project level. "I told you about this a month ago." is the canonical antipattern. Did this person follow up? Was there a clear delineation of responsibility? Was everyone clear on what needed to be accomplished, and by when? There are Staff, Infrastructure, and Board project walls in GitLab to track who's owning what. The board needs to be held accountable for work at the strategic level: what are the goals of the organization for this year? Five years? Ten years? Is the ED ensuring that we meet those goals? Last, the ED needs to be held accountable for both. The ED helps the board decide on strategy and enables the staff to execute on it. In an organization as small as the GNOME Foundation, the ED will be executing on a lot of tasks herself, directly. Such a small organization has no choice but to operate cross-functionally.
...
The Foundation will benefit from transparency. _A lot more_ transparency. Private, members-only conversation channels help with this. [Foundation Updates](https://blogs.gnome.org/aday/) help with this. Fresh blood in leadership positions at the Foundation helps with this. But every one of these is really just the beginning. The Foundation will achieve excellence, in my opinion, when it finds an optimal balance in the act of sharing the majority of its strategy, execution, and operation with the membership --- in a way that is easy to digest and receptive to feedback.

The word "balance" here is key. It does not make the GNOME Foundation "transparent" if everyone can read every line item in the organization's accounting history, see what every contractor is being paid, or record every board meeting on video and publish it to YouTube. Spreading every little detail out on the table just creates a firehose of information no one can keep up with, which would only act as a magnet for trolls.

Other organizations indulge the firehose, and that's fine. Buffer [publishes its employees salaries](https://buffer.com/open). The postmarketOS team [publish a financial transparency report](https://postmarketos.org/blog/2025/12/19/contributor-compensantion-and-financial-update/) that links to spreadsheets. These are extreme examples. The GNOME Foundation can't go this far, in part because it needs to consider the safety of staff and the sanity of its directors.

It's also important to consider that different layers of the organization require transparency at different scales. The membership, the board, the executive, the staff, the wider hacker community, and the general public all produce and consume information at different rates and at different volumes. With a Community Executive, the Foundation enjoys fewer layers to contend with and transparency as a function of public relations is simplified. That's a good thing.

The value of increased transparency will be immense. Transparency --- especially transparency at the right scale, granularity, and volume, targetting the right audience --- will rebuild the community's trust in the Foundation. Members will then be more likely to participate, which in turn will lead to more vibrant elections, which in turn will lead to higher transparency by community osmosis. Another virtuous circle.

### Board of Directors

Some day in the future, _too many_ people will run for board elections. When that happens, it will clearly signal that the Foundation is healing. It should be an honour to sit on the board of directors. And it will be, eventually.

This is one aspect of the Foundation I had backward, initially. When I joined in May, I tried as hard as I could to recruit candidates with accounting, legal, governance, and management backgrounds. _"Just because someone has mastered Rust and GTK doesn't make them a great director,"_ I thought. And while that's true, just because someone has a management background doesn't make them a great director, either.

In my brief experience, the strongest directors have been those with an unwavering and contemporary commitment to GNOME. They aren't on the board to boost their own organization's standing and they aren't there to twist the knife on petty grievances. Good directors sit on the board because they want to see GNOME stronger in 2056 than it is in 2026. Good directors put in the work. Good directors tackle conflict head-on and have the difficult conversations.

Hackers can absolutely make great directors.

One of the biggest changes I would like to see is a representative from Canonical on the GNOME Foundation board. Canonical has Advisory Board representatives but very few Canonical employees even seem to have Foundation membership. Step one: get your Ubuntu friends a Foundation membership! Step two: get at least one Ubuntu Desktop person on the board. You folks are in this together. Team up for real.

### Policy Governance

I spoke about [Policy Governance](https://en.wikipedia.org/wiki/Policy_Governance) in [my GUADEC 2025 keynote](https://youtu.be/26ys1p6VVs0?t=1286). As I mentioned in the intro, I worked almost exclusively with Allan Day for my 3 or 4 months at the Foundation. I really enjoyed working with Allan and I believe that, generally, we agreed on how the Foundation should operate. Since the day I left, he's been doing an excellent job of leading the Foundation.

Policy Governance is the one place where Allan and I differed in opinion. He's been around both GNOME and the Foundation for much longer, so perhaps he knows better. He has expressed the opinion that the board's heavy involvement in the Foundation's operation is a good thing. I tend to disagree. I believe a high level of involvement from the Executive Committee in a 501(c)(3) is an antipattern, indicative of cash flow issues, a failure of management, or a failure of operations --- or all three.
...
Perhaps, years in the future, the board _will_ choose to hire another staff executive. If and when they do, I still believe that Policy Governance will be their friend and I will continue to advocate for it along those timelines.
...
Although GNOME is an upstream project, it feels to me like it is at risk from a lack of corporate diversity. The Red Hat Desktop team does amazing work but GNOME benefits from diversification of downstreams. It would be lovely to see heavier involvement from the Ubuntu Desktop folks --- not just on the board, but everywhere. There are other downstream software and hardware players, too. The more companies that get involved in GNOME, the healthier GNOME will be. This is just network resilience again, for software bus factor.

Financially, the Foundation itself will benefit from diversified revenue streams. I hear that the new user donation platform is moving along smoothly. Yay! Next, Foundation management needs to dovetail those donations from individuals into larger donations from corporate donors. (And the Foundation's good friends at the PSF and OpenSSL Foundation have great advice in this area.) It's not just about money. As a 501(c)(3), the GNOME Foundation needs to pass a [Public Support Test](https://www.501c3.org/understanding-the-501c3-public-support-test/) every year. As Jef Spaleta, the Fedora project lead, put it: "more individual donors raise the ceiling on how many big donations the Foundation can receive... everybody wins." In the same way that many small donations from individuals are better, a large number of medium-sized donations from corporations is preferable to one or two large cheques every year.

Culturally, GNOME is very [safe](https://web.archive.org/web/20251012011628/https://blogs.gnome.org/steven/2025/05/28/on-safety/) and inviting, which is fantastic. GNOME benefits from a broader base of contributors, from all walks of life. This isn't just a case of "more hackers = better". Growing communities for the long term in locations outside of Berlin and Boston will ensure GNOME's longevity and vibrance. [GNOME Nepal](https://nepal.gnome.org/) is the perfect example of how to execute on this: start small and humbly, embrace the local community, and tackle challenges head-on. GNOME Nepal is walking the long arc from the baby steps of growing Linux adoption to the hard work of onboarding new contributors. That kind of effort takes years and requires someone like Aaditya to have the vision _and_ execute on it. The GNOME Foundation Infrastructure Team has done a fantastic job of supporting GNOME Nepal. I hope the management team will use GNOME Nepal as a template for growing GNOME in other parts of the world.
...
The first is to embrace other Free Software organizations: [third-wave open source](https://www.deobald.ca/essays/2024-08-13-third-wave-commercial-open-source/) companies, newer nonprofits like [FOSS United](https://fossunited.org/), hardware manufacturers who believe in [open hardware](https://frame.work/) as much as open source, and governments who are willing to [acknowledge the lies of the old world order](https://youtu.be/flsgJe8mN-A?t=154) and now look for cooperative, sovereign technology alternatives.

The second is, over time, to untether the Foundation from legacy f/oss nonprofit social networks and embrace new ones. It's not 1997 anymore and I have not witnessed these old social networks benefitting GNOME. While I was ED, other Executive Directors and CEOs in the Free Software world repeatedly described these old networks to me with a single, ugly word: "incestuous." There are millions of skilled people out there to hire. The only advantage to hiring "in network" is the false sense of security it brings. Get new people excited instead of going to the same well over and over. Find new donors. Attend conferences other than (or at least in addition to) the usuals like FOSDEM and SCALE.
